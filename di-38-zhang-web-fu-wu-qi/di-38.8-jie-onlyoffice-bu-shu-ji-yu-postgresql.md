# 38.8 OnlyOffice Deployment (Based on PostgreSQL)
...
```sh
# rabbitmqctl --erlang-cookie `cat /var/db/rabbitmq/.erlang.cookie` add_user onlyoffice password  # Note: This step may take several minutes, same below
