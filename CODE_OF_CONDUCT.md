...
- Respect others;
- Choose your words carefully and be kind to others;
- When disagreements arise, try to see things from others' perspectives.
...
- **Be friendly and patient.**
- **Welcome others.** We strive to be a community that welcomes and supports people of all backgrounds and identities. This includes, but is not limited to, members of any race, ethnicity, culture, nationality, color, immigration status, social and economic class, educational level, gender, sexual orientation, gender identity and expression, age, body size, family status, political belief, religious belief, and mental and physical ability.
- **Be considerate of others.** Your work will benefit others, and you will depend on the work of others. All your decisions will affect users and colleagues, and you should consider these consequences. Remember that we are a global community, so you may not be communicating with someone in their native language.
- **Respect others.** We do not always agree, but disagreement is not an excuse for bad behavior. We may feel frustrated, but we must not let frustration turn into personal attacks. Remember, a community that is uncomfortable or threatening is not a productive community. Members of the FreeBSD community should maintain respect when dealing with other members and people outside the community.
- **Choose your words carefully and be kind to others.** Do not insult or belittle other participants. Harassment and other exclusionary behaviors are unacceptable. This includes, but is not limited to:
  - Violent threats or language directed at others.
  - Discriminatory jokes and language.
  - Posting sexually explicit or violent content.
  - Posting (or threatening to post) others' personally identifiable information ("doxing").
...
The above text is translated from the [FreeBSD Community Code of Conduct](https://www.freebsd.org/internal/code-of-conduct/).
