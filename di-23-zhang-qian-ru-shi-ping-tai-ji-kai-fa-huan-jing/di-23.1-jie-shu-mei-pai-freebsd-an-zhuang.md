# 23.1 Raspberry Pi FreeBSD Installation
...
- FreeBSD Chinese Community. Raspberry Pi Chinese Documentation[EB/OL]. [2026-03-25]. <https://rpicn.bsdcn.org>. A guide for daily installation, configuration, and use of the Raspberry Pi.
...
- Kingston Technology. DataTraveler 100 G3 USB 3.0 Flash Drive - Technical Support[EB/OL]. [2026-03-25]. <https://www.kingston.com/cn/support/technical/products/dt100g3>. Technical specifications and support documentation for the Kingston DT100G3 USB drive.
...
3. Use a tool such as [Rufus](https://rufus.ie/zh/) to write the image to the SD card, creating a bootable medium;
