...
Not all Minecraft versions are supported; for compatibility details, please refer to the [Platform Support Status](https://github.com/HMCL-dev/HMCL/blob/main/docs/PLATFORM_zh.md) document. The remaining settings are platform-independent; key configurations include Java path settings, game directory selection, and memory allocation.
...
> **Note**
>
> A Minecraft licensed account is required to log in to the game. You can [purchase](https://www.minecraft.net/zh-hans/store/minecraft-java-bedrock-edition-pc) the game.
